...
llm_resto = ChatGroq(
    api_key= "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",
...
def recommend():
    if request.method == "POST":
        ...
        return render_template('result.html', restaurant_names = restaurant_names, breakfast_names=breakfast_names, lunch_names=lunch_names, dinner_names = dinner_names, workout_names=workout_names)
    return  render_template("index.html")
